...
| такие как правила размера. Не стесняйтесь настраивать каждое из этих сообщений здесь.
|
*/
...
/*
|--------------------------------------------------------------------------
| Пользовательские строки языка валидации
|--------------------------------------------------------------------------
|
...
| конкретное пользовательское языковое сообщение для определенного правила атрибута.
|
*/
...
|--------------------------------------------------------------------------
|
| Следующие строки языка используются для замены плейсхолдеров атрибута
